...
bgImage.src = 'public/images/isometric_Test_Grid.png';
...
function playerProjectile(speedShot) {
    ...
    if (65 in keyMap) {
        ...
        speedShot[j] = new component(speedShot[j].width, speedShot[j].height, speedShot[j].color, player.x, player.y);
    ...
    if (speedShot[j].x > canvas.width || speedShot.y > canvas.height){
